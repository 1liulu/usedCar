package com.car.framework.aspectj;

import com.car.common.annotation.Log;
import com.car.common.enums.BusinessStatus;
import com.car.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.car.common.annotation.Log)")
